...
<div class="container">
    <a href="../add/new_test_collab.php" class="btn btn-success"><i class="bi bi-plus-circle-fill"></i>  <strong>Nueva Evaluación</strong></a><br><br>

    <div class="container form">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header2"><br>
                    <img class="user_pic" src="../../../assets/img/evalaucion_colaborador.png"><h1 class="animated lightSpeedIn title-users">Evaluaciones de Colaboradores</h1>
                </div><br>
                
            <div class="card">
            <div class="card bg-primary text-white"><center><h6><strong>Puedes realizar cualquier acción permitida con las evaluaciones enlistadas</strong></h6></center></div>
            </div>
