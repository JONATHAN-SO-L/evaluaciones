        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header2"><br>
                    <img class="user_pic" src="../../../assets/img/objetivos.png"><h1 class="animated lightSpeedIn title-users">Objetivos SMART Colaboradores Siguiente Año</h1>
                </div><br>
            ...
            <div class="table-responsive mt-3">
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <td>
                        <div class="btn-group">
                        <a href="obj_nextyear_collab.php" class="btn btn-sm btn-success"><i class="bi bi-eye-fill"></i> Ver</a>
                        </div>
                    </td>
                    <td>Ruben Ramírez</td>
